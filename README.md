...
<body>
        ...
        <div class="main-content menu-content">
            ...
            <nav>
                <ul onclick="getElementByid('close-menu').checked = false;">
                    ...
                    <li><a href="#gallery">gaellery</a></li>
    ...
    <section id="home" class="main-bg section">
        <div class="main-content intro-content">
            ...
            <div class="intro-img">
                <img src="~/css/Java.svg" alt="Logo de HTML, CSS e JS." />
            </div>
        </div>
    </section>
    ...
    <section id="grid-one" class="grid-one main-bg section">
        <div class="main-content grid-one-content">
            <h2 class="grid-main-heading-one-content">My Grid</h2>
            <p class="grid-description">Uma breve descrição.</p>

            <div class="grid">
                <article>
                    <h3>Teste 1</h3>
                    <p>Lorem ipsum dolor sit, amet consectetur adipising elit. Debitis cum delectus molestias. Atque doloribus nobis laudantium esse ut, non commodi maxime distinctio veritates unde, reprehenderit minus ad dolores provident maiores.</p>
                </article>
                <article>
                    <h3>Teste 2</h3>
                    <p>Lorem ipsum dolor sit, amet consectetur adipising elit. Debitis cum delectus molestias. Atque doloribus nobis laudantium esse ut, non commodi maxime distinctio veritates unde, reprehenderit minus ad dolores provident maiores.</p>
    ...
    <section id="contact" class="main-bg section">
        <div class="main-content intro-content">
            ...
            <div class="contact-form">
                <fieldset class="form-grid full-width">
    ...
    <footer id="footer" class="footer">
        <p><a rel="nofollow" target="_blank" href="https://beacons.ai/eliasouza">Feito com<span class="heart"> ♥ </span> por Cláudio Elias </a></p>
    </footer>
